/**
 * ClassicTemplate.tsx — Self-contained Classic Wedding Invitation
 * 
...
import { Heart, Menu, X, ChevronLeft, ChevronRight, MapPin, ExternalLink, Sun, Moon } from 'lucide-react';
...
const ClassicTemplate = () => {
  ...
  return (
    <div id="template-root" className="theme-classic bg-background text-foreground min-h-screen transition-colors duration-500">
      <WeddingNav items={navItems} coupleNames={`${data.couple.bride} & ${data.couple.groom}`} />
      <ThemeToggle defaultDark={false} />
      <HeroSection bride={data.couple.bride} groom={data.couple.groom} date={data.date} backgroundImage={data.gallery[0]} variant="minimal" />
      <Countdown targetDate={data.date} />
      <div className="wedding-divider" />
      <Gallery images={data.gallery} columns={2} />
      <div className="wedding-divider" />
